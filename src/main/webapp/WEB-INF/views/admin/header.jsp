...
<header>
    <hr>
    <h1>Admin</h1>
    <a href="<c:url value='/project/all'></c:url>">Projekty</a>&nbsp;&nbsp;
    <a href="<c:url value='/project/form'></c:url>">Nowy projekt</a>&nbsp;&nbsp;
    ...
    <a href="<c:url value='/priority/form'></c:url>">Nowy priorytet</a><br/>
</header>
